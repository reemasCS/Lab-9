...
## Steps Completed
1. **Data Exploration:** Visualized FICO scores and interest rates using histograms and jointplots.
2. **Data Transformation:** Handled the categorical 'purpose' column by creating dummy variables.
3. **Train-Test Split:** Divided the dataset into training and testing sets (70/30 split).
4. **Model Training:** Trained a Single Decision Tree and a Random Forest Classifier with 600 estimators.
